...
class PropertiesAdapter(
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private var propertieNeighborhood = itemView.findViewById<TextView>(R.id.imovel_neighborhood)
        ...
        private var propertieParkingSpaces = itemView.findViewById<TextView>(R.id.imovel_parkingSpaces)
        private var propertiePrice = itemView.findViewById<TextView>(R.id.imovel_price)
        private var propertieTotalPrice = itemView.findViewById<TextView>(R.id.imovel_rental_total_price)
